    ...
    <div className="row mt-3">
      <div className="col">
        ...
        <div className="form-check">
            ...
            <div className="row">
              ...
              <div className="col-sm-5 p-0"><input type="date" className="form-control date-form" placeholder="Masukan tanggal" /></div>
      ...
      <div className="col">
       ...
       <div className="row d-flex   justify-content-end" >
        ...
        <div className="col-sm-auto">
          <button type="button" class="btn btn-info">Terapkan</button>
        </div>
